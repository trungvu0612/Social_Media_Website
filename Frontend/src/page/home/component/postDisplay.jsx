...
export default function PostDisplay() {
  return (
    <div className="postdisplay post-list post-list-0 active">
      <PostItems
        owneravatar="/img/avartar.jpg"
        postowner="Quốc Long"
        content='Hãy nhớ rằng, đó không phải là nội dung của bạn. Nó thậm chí không
        ...
        ("Người tải lên") và bạn phải tôn trọng quyền của họ mọi lúc. Việc sử
        dụng sai Nội dung của Người dùng có thể cấu thành vi phạm bản quyền và
        dẫn đến việc Người tải lên hoặc chủ sở hữu bản quyền khác sẽ thực hiện
        hành động chống lại bạn.'
        imgmusic="/img/img_music/1.jpg"
        namemusic="EDM"
        authormusic="Chưa biết tên"
        linkmusic="/music/khong_loi/acoustic/bensound-buddy.mp3"
      />
